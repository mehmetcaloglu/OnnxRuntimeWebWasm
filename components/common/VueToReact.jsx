    ...
    return (
        <Card >
            <CardHeader className='items-center'>
                <div className='flex flex-1 self-center'>               
                    ...
                    <SelectTrigger >
                        ...
                        <SelectContent>                        
                            <SelectItem key={backendSelectList[0].value} value={backendSelectList[0].value}>
                                {backendSelectList[0].text}
                            </SelectItem>
                            <SelectItem key={backendSelectList[1].value} value={backendSelectList[1].value}>
                                {backendSelectList[1].text}
                            </SelectItem>                
                        </SelectContent>
                    </Select>
            ...
            {(!modelLoading && !modelInitializing) ? <>
                <CardContent>
                <div className=" relative flex items-center justify-center w-full h-full bg-gray-100 rounded-lg shadow-md"  style={{ width: "416px", height: "416px",aspectRatio:"auto" }}>
                    <div className="webcam-container border rounded-md shadow-sm m-auto relative flex items-center justify-center"  id="webcam-container" ref={webcamContainer} style={{ width: "416px", height: "416px", }}>
                        <video id="webcam" autoPlay playsInline muted ref={webcamElement} width="416" height="416" style={
                            {
                                width: "416px",
                                height: "416px",
                                objectFit: "cover",
                    ...
                    <div className="infer-time m-12 items-center text-center justify-center"> <h1 className='text-center flex'>Model Inference Time {inferenceTime} ms</h1>  </div>
            </CardContent>
            <CardFooter className=' justify-center'>
                <div className="self-center m-auto">
                    {(!modelLoading && !modelInitializing) ? (
                        <div className="m-12">
                            <Button variant="destructive" className='m-4' disabled={sessionRunning} onClick={webcamController}>{webcamEnabled ? 'Stop Camera' : 'Start Camera'}</Button>
                        </div>
                    ) : (
